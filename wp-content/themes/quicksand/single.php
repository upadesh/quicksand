...
//            get_template_part('template-parts/content', 'single');
        ...
        <div class="post-pagination">
            ...
            if (is_singular('attachment')) {
                ...
                the_post_navigation(array(
                    'prev_text' => '<span class="meta-nav btn btn-secondary post-last-link" aria-hidden="true"><i class="fa fa-long-arrow-left"></i>' . esc_html(__("Previous Post", "quicksand")) . '</span>' .
                    '<span class="screen-reader-text">' . __('Previous post:', 'quicksand') . '</span> ',
                    'next_text' => '<span class="meta-nav btn btn-secondary post-next-link " aria-hidden="true">' . esc_html(__("Next Post", "quicksand")) . '<i class="fa fa-long-arrow-right"></i></span>' .
