...
( function( api ) {
	var cssTemplate = wp.template( 'wp-bs-theme-simple-scheme' ),
		colorSchemeKeys = [
			'background_color',
...
( function( $ ) {
	var style = $( '#wp-be-theme-simple-color-scheme-css' ),
		api = wp.customize;

	if ( ! style.length ) {
		style = $( 'head' ).append( '<style type="text/css" id="wp-be-theme-simple-color-scheme-css" />' )
		                    .find( '#wp-be-theme-simple-color-scheme-css' );
	}
