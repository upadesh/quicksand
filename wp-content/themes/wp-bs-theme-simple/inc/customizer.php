<?php
/**
 * WP-bs-theme-simple Customizer functionality
 *
 * @package WordPress
 ...
 * @since WP-bs-theme-simple 0.0.1
 *
 * @see wp_bs_theme_simple_header_style()
 */
function wp_bs_theme_simple_custom_header_and_background() {
    $color_scheme = wp_bs_theme_simple_get_color_scheme();
    $default_background_color = trim($color_scheme[0], '#');
    $default_text_color = trim($color_scheme[3], '#');

    /**
     * Filter the arguments used when adding 'custom-background' support in WP-bs-theme-simple.
     *
     * @since WP-bs-theme-simple 0.0.1
     *
     * @param array $args {
     ...
     * }
     */
    add_theme_support('custom-background', apply_filters('wp_bs_theme_simple_custom_background_args', array(
        'default-color' => $default_background_color,
    )));

    /**
     * Filter the arguments used when adding 'custom-header' support in WP-bs-theme-simple.
     *
     * @since WP-bs-theme-simple 0.0.1
     *
     * @param array $args {
     ...
     * }
     */
    add_theme_support('custom-header', apply_filters('wp_bs_theme_simple_custom_header_args', array(
        'default-text-color' => $default_text_color,
        'width' => 1200,
        'height' => 280,
        'flex-height' => true,
        'wp-head-callback' => 'wp_bs_theme_simple_header_style',
    )));
}

add_action('after_setup_theme', 'wp_bs_theme_simple_custom_header_and_background');



if (!function_exists('wp_bs_theme_simple_header_style')) :

    /**
     * Styles the header text displayed on the site.
     *
     * Create your own wp_bs_theme_simple_header_style() function to override in a child theme.
     *
     * @since WP-bs-theme-simple 0.0.1
     *
     * @see wp_bs_theme_simple_custom_header_and_background().
     */
    function wp_bs_theme_simple_header_style() {
...
endif; // wp_bs_theme_simple_header_style
...
function wp_bs_theme_simple_customize_register($wp_customize) {
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'page_background_color', array(
        'label' => __('Page Background Color', 'wp-bs-theme-simple'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'link_color', array(
        'label' => __('Link Color', 'wp-bs-theme-simple'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'main_text_color', array(
        'label' => __('Main Text Color', 'wp-bs-theme-simple'),
        'section' => 'colors',
    )));
 ...
 *
 * @since WP-bs-theme-simple 1.2
 * @see wp_bs_theme_simple_customize_register()
 *
 * @return void
 */
function wp_bs_theme_simple_customize_partial_blogname() {
    bloginfo('name');
}
...
function wp_bs_theme_simple_customize_control_js() {
    // Not needed because it's already concated 
...
function wp_bs_theme_simple_customize_preview_js() {
    // Not needed because it's already concated 
//    wp_enqueue_script('wp-bs-theme-simple-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array('customize-preview'), '20160816', true);
}
 ...
 * @since WP-bs-theme-simple 0.0.1
 */
function wp_bs_theme_simple_color_scheme_css_template() {
    $colors = array(
    ...
    ?>
    <script type="text/html" id="tmpl-wp-bs-theme-simple-color-scheme">
    <?php echo wp_bs_theme_simple_get_color_scheme_css($colors); ?>
    </script>
    <?php
}

add_action('customize_controls_print_footer_scripts', 'wp_bs_theme_simple_color_scheme_css_template');
 ...
 * @see wp_add_inline_style()
 */
function wp_bs_theme_simple_page_background_color_css() {
    $color_scheme = wp_bs_theme_simple_get_color_scheme();
    ...
    wp_add_inline_style('wp-bs-theme-simple-style', sprintf($css, $page_background_color));
}

add_action('wp_enqueue_scripts', 'wp_bs_theme_simple_page_background_color_css', 11);
 ...
 * @see wp_add_inline_style()
 */
function wp_bs_theme_simple_link_color_css() {
    $color_scheme = wp_bs_theme_simple_get_color_scheme();
    ...
    wp_add_inline_style('wp-bs-theme-simple-style', sprintf($css, $link_color));
}

add_action('wp_enqueue_scripts', 'wp_bs_theme_simple_link_color_css', 11);
 ...
 * @see wp_add_inline_style()
 */
function wp_bs_theme_simple_main_text_color_css() {
    $color_scheme = wp_bs_theme_simple_get_color_scheme();
    ...
    // Convert main text hex color to rgba.
    $main_text_color_rgb = wp_bs_theme_simple_hex2rgb($main_text_color);
    ...
    wp_add_inline_style('wp-bs-theme-simple-style', sprintf($css, $main_text_color, $border_color));
}

add_action('wp_enqueue_scripts', 'wp_bs_theme_simple_main_text_color_css', 11);
 ...
 * @see wp_add_inline_style()
 */
function wp_bs_theme_simple_secondary_text_color_css() {
    $color_scheme = wp_bs_theme_simple_get_color_scheme();
    ...
    wp_add_inline_style('wp-bs-theme-simple-style', sprintf($css, $secondary_text_color));
}

add_action('wp_enqueue_scripts', 'wp_bs_theme_simple_secondary_text_color_css', 11);
